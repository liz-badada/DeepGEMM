...
G2_PERF_CONFIG = (6, 4096, 1024, 4096, 4096)
...
def test_performance():
    ...
    for num_groups, max_m, expected_m, n, k in [
        ...
        is_g2_perf = (num_groups, max_m, expected_m, n, k) == G2_PERF_CONFIG
        if is_g2_perf:
        ...
        mask_note = " mask=round128" if is_g2_perf else ""
        label = f"{num_groups}g exp={expected_m} {n}x{k}{mask_note}"
